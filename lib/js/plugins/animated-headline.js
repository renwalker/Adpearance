jQuery(document).ready(function($){
	...
	var animationDelay = 3500,
		...
		lettersDelay = 50,
		//type effect
		typeLettersDelay = 90, //how fast each letter is typed
		selectionDuration = 520, //how long the highlighted election is held
		typeAnimationDelay = selectionDuration + 200, //delay between removal and written
		//clip effect 
		revealDuration = 600,
